                                ...
                                <div class="card-body">
                                    <table class="table" table-bordered table-striped" id="table"">
                                        @foreach ($successes as $item)
                                            ...
                                            <tr>
                                                <td>
                                                    <span>Chefe de Turma:</span> <i>{{ $item->team_boss_name }}</i>
                                                    <span class="ml-3">ID:</span> <i>{{ $item->team_boss_id }}</i>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <span>Número do R.O.:</span> <i> {{ $item->ro_number }}</i>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <span>Número do Lacre:</span> <i> {{ $item->seal_number }}</i>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
